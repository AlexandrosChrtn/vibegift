...
const HomePage = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-gradient-to-br from-background to-secondary/30">
      <Header />
      <main className="flex-grow container mx-auto px-4 md:py-24 py-[24px]">
        <section className="text-center animate-fade-in" style={{
        animationDelay: '0.2s'
      }}>
          <Gift className="h-24 w-24 text-primary mx-auto mb-6 animate-bounce" style={{
        ...
        <section className="py-16 md:py-24 animate-fade-in" style={{
        animationDelay: '0.5s'
      }}>
          <h2 className="text-3xl font-bold text-center mb-12 text-primary">How It Works</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => <div key={feature.title} className="bg-card p-8 rounded-xl shadow-lg text-center hover:shadow-2xl transition-shadow duration-300 animate-fade-in" style={{
