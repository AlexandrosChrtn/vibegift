      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8">
            This AI Gift Finder was made by Alexandros Chariton for Lovable's competition, leveraging the coolest AI model out there to help you find the perfect gift!
          </p>
